...
### Let's Practice :computer: 
 ...
 ```
- Create an Object called `bigfoot` with properties of `shoesize`, `height`, and `current location`. 
...
2. Arrays are guaranteed to stay **in order**. For efficiency purposes, objects are not. 
